...
;; ChatGPT AI integration (lazy)
(use-package chatgpt-shell
  :straight (chatgpt-shell
             :type git :host github :repo "xenodium/chatgpt-shell")
  :commands (chatgpt-shell)          ;; autoload the entry command
  :init
  ;; keep secrets/keys set before load
  ...
  ;; this keybinding is also lazy; the package loads on first press
  :bind (("C-c g" . chatgpt-shell)))

;; Ollama (lazy)
(use-package ollama-buddy
  :straight (ollama-buddy
             :type git :host github :repo "n20o/ollama-buddy")
  :commands (ollama-buddy-chat
             ollama-buddy-prompt-region
             ollama-buddy-prompt-buffer))
#+END_SRC
