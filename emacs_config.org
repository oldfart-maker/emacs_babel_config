...
Emacs Custom File
Don't load it to keep all .el files generated from tangle. This will simply be a cache file for emacs settings.
#+BEGIN_SRC emacs-lisp :tangle ./modules/env.el
  (setq custom-file (expand-file-name "custom.el" user-emacs-directory))
#+END_SRC

#+RESULTS:
: /home/username/.emacs.d/custom.el
...
Git integration (disabled - cannot load)
